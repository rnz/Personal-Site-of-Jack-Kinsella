---
layout: post
title: Janki Method - A Faster Way to Learn Programming 
subtitle: Using spaced repetition systems to learn and retain technical knowledge
author: Jack Kinsella

---

<meta property="og:title" content="Janki Method: A Faster Way to Learn Programming"/>
...
Well-intentioned learners sometimes flop around in the dark, despite abundant smarts and enthusiasm. The main determinant of their eventual ability is volume of time expended.  Ten years sounds about right.

You’ve read that learning by doing is better than passive reading; that expressing ideas in writing forces understanding; that knowledge needs constant revision to stay fresh; that creativity comes from linking disparate ideas; and that your past mistakes are your best teachers. The question then is do you apply this knowledge systematically to your learning efforts.
...
My deck focuses on the Ruby on Rails technology stack, including cards on Ruby and Rails 3.1, the HTTP protocol, the Unix command line, git, CSS, JavaScript, VIM, Rspec, Capybara, TDD, Coffeescript, jQuery, deployment, design patterns, regular expressions, SQL, and refactoring. It's everything I've needed to build, manage and deploy a variety of web apps. This is not a commercial product, so do not expect polish or total accuracy. [*Edit* - I won't be putting my deck online until late December. Please come back then. Sorry.]
...
* "The 20 rules of formulating knowledge in learning":http://www.supermemo.com/articles/20rules.htm
...
I'm visiting San Francisco during December 2011, so get in touch if you’d like to meet for lunch/coffee/beer. I’m looking to take on new consulting projects, or just have a friendly chat with local technies about programming, entrepreneurship, making money online, web apps, online marketing and all the usual suspects. Get in touch.
