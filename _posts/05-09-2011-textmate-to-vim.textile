...
* Regular expressions in VIM differ from those in Textmate, and these are outside the scope of this guide. I will say this though: you can make them similar by adding this to your .vimrc.local:
@nnoremap / /\v@
@vnoremap / /\v@
_This prefixes you regexes with \v.  Use of "\v" means that in the pattern after it all ASCII characters except
'0'-'9', 'a'-'z', 'A'-'Z' and '_' have a special meaning.  "very magic". Without this you would need to escape many characters which are standard regex syntax in, say, Ruby._
...
|Switchcase of selected text | No equivalent | ~ |
