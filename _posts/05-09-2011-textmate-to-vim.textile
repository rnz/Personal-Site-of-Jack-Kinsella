...
* Regular expressions in VIM differ from those in Textmate, and these are outside the scope of this guide. 90% of these difference will be alleviate if you add this to your .vimrc.local:
@nnoremap / /\v@
@vnoremap / /\v@
