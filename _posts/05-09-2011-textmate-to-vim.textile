...
|Create new in Project Drawer | File > new | [Select Project Drawer. Highlight parent folder you'd like file to appear in. Type m the choose a from select menu and type desired filename]|
|Delete a file| | [Highlight undesired file file in Project Drawer. Type m then choose d from drop down menu.]|
...
_. here represents the current line. You can subsitute this for other lines e.g. :40Rake_ TEST|
