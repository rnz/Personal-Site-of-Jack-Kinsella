...
When I switched from Textmate to VIM I felt like a tourist lost on a Japanese subway without a guide, translator or hope. I was unable to find in VIM the features I'd come to love and rely on in Textmate. I yearned for ⌘ + T to summon my models, and I longer for a project drawer to manage my app's files. 

Instead of accommodating my needs, VIM sat firm and unresponsive, save for the odd judgemental beeping sound. Even though I was supposed to go cold turkey on Textmate, I met her by night in the yard for a guilty after-hours edit.
...
* If you instructed to add something to your vimrc.local or gvimrc.local files you will need to restart VIM for these changes to take effect. 
* If you are instructed to add code to your .janus.rake file you must cd into your ~/.vim directory and run rake for these changes to be installed. 
* Regular expressions in VIM differ from those in Textmate, and these are outside the scope of this guide. Consult the "resources below":#vim_training_resources for an excellent tutorial.
...
|Rename a file|[focus on project drawer and select a file] space [type new name]| Start by "focusing on the NERDTree":#nerd_tree. Select the file you wish to rename (however you want: e.g. with a search or plain old jklh). Type 'm' to bring up a menu. Type 'm' again to chose to modify the file name. Type the new name of file and press enter. |
...
_Remember the key is to train your fingers. Don't just read the commands; open up a blank file and try out different commands. If you want to get good at VIM you need to have the confidence to tear a file up in your training sessions._
