...
The Janki method began it's life as my response to my dissatisfaction with my memory. I always reasoned well with the facts at my disposal. The problem was that I didn't always have the correct facts, since knowledge painfully acquired mere months earlier would quickly slip from memory. I needed to reference the original material again and again, and relearn the same techniques over and over. My mind was wholly bucket and my knowledge was the liquid dripping out from under.  I've read that your brain never really forgets anything, and so that knowledge is supposed to reside somewhere deep inside , but for my use case as a professional, that knowledge is no longer with me and so I needed to relearn it. This was a massive waste of time.

My solution to the wholly bucket problem was this: every time I learned anything about programing, I would create a flash card and add it to a spaced repetition system (SRS) named Anki. From then on, I drilled myself daily with the cards Anki's algorithm determined as most in need of review. The premise of SRS systems like ANKI is that knowledge entered into the system and regularly reviewed never leaves your memory. I've found this claim to be true for 95% of facts.
...
The only truly stupidity is repeating your mistakes. Everyone makes mistakes once, and that's OK. What isn't OK is making the same mistake twice, thrice or even more. They say an old dog doesn't learn new tricks. That's not completely true. Old dogs learn new tricks, they just need a lot of training.  I've found that prior to adopting the Janki method it took me three mistake repetitions before I learned my lesson. I also noted that I would eventually forget all but my most serious mistakes.

My problem with this is that I've making the same mistake more than once. This wasn't acceptable so I asked how I could minimize the number of failures necessary before I learned my lesson? To combat this Janki method requires you to create a new lesson in your deck following every bug solved, every error fixed, and every project completed. Everything becomes a learning experience. You no longer beat yourself up after an error, you insteads scan for take-aways. You've just improved your knowledge.

h2. Anki explained 

Anki is a multi-platform flash card program available for free download on every device you can think of. You begin by creating a deck, say "Computer Science". A deck contains many facts, facts being a question and corresponding answer. You can tag these facts with the names of the categories they belong to, for example a fact might be categorised under 'rails', 'git', or 'javascript', or perhaps even all three at once.

3 x Examples

If all Anki did was let you categorize your knowledge it would still be a useful tool for recording and documenting old insights. But Anki goes much further. Every morning, Anki presents you with a set of old facts you need to review. This is calculated using the Supermemo algorithm, an algorithm invented by PIOR??????. Most algorithms make computers efficient; the SuperMemo algorithm makes you efficient. It is based on Pior's research on the forgetting curve, and it is designed to place facts into your long term memory using the minimal number of repetitions. It works exceedingly well.

You add a new card to your deck. Anki makes you review it one day later, then a week later, a month later, 3 months later, a year later and so on. RESEARCH (how many reps in life). If you review a previously learned fact but fail to remember it, that fact will be considered new once again, and it must start the cycle afresh. 

h3. Eat your meat.

You do your ANKIs every morning. For each fact you need to review you will see the question, and the answer will be blocked out. You must answer in your head, then press the enter key to have the answer revealed. At the bottom of the screen will be four buttons: again, good, easy and very easy. Use these to honestly assess whether you remembered the fact and, if so, how easy the recall was. Your self evaluation matters; the algorithm modifies the number of days until your next review of that card based on how well you say you know the fact. 

eXample of question

h3. Time Leeches

If you get a card wrong frequently Anki will suspend it from your deck. The reasoning here is that certain cards are time leeches, as they frequently trip you up and prevent you from using your time efficiently. I view leeches as indicators of a poor question-answer pair. Am I putting too much in one card? Would a mnemomic make the fact easier to remember? Is this worth memorising at all?

h3. Every day. Including Sundays.
...
h3. 2. Design Away From Your Machine
...
h3. 3. Inspiration through through collision
...
h3. 4. Build a deeper understanding of your domain 
...
h3. 4. Have a Definitive Searchable Reference of All Your Programming Knowledge
...
h3. 5. Feel Like You Are Making Progress

h3. 5. Impress Interviewers
