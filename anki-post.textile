...
subtitle: Using Spaced Repetition Systems To Learn Programming Exponentially Faster
...
On the 1st May 2010 I set myself the goal of learning Ruby,Rails,Git,Linux,Javascript,Jquery,Object Orientated Programming,Regular Expressions,Css,Html,Refactoring,Design Patterns,deployment,boolean logic,VIM,TDD and the HTTP protocol in the shortest amount of time possible. I'd dabbled in programming before, even cobbled together two websites and a replica of the old mobile phone game 'snake' which invariably crashed after 100 seconds of gameplay. But I was basically a rookie. I studied law during my college years, and so without a scientific degree I was starting programming from scratch. 

Fast forward a year and a half and I'm now capable of producing a Rails app a week, and have done so for the past five weeks for my current client. I have a 70 model Rails app which I built, designed, deployed and marketed without any external help. It pulled in over $30k in profit last year, and I expect double that in the coming year.

The following is a frank and honest guide on how any reasonably intelligent and disciplined person can learn do the same within a similar time frame.

h2. The Initial Motivations

During my college years I realized that the single biggest impediment to my ability was my memory. My logic was sharp, but I forgot facts quickly. Modules I spent a great deal of time learning only a year earlier were practically wiped from my memory when I revisted them a year later. The JANKI method began it's life as my response to my frail memory.  The premise to the JANKI method was simple: every time I learned anything new about the above technologies, or gained deeper wisdom about programming, I would create a flash card and add it to my spaced-repetition system of choice, ANKI. Every morning, before starting work, I drilled myself with the cards the ANKI algorithm determined as most in need of review.

Initially I thought the only advantage of this method would be long term memory. As the days turned to weeks and months the method evolved into something more powerful that I had initialy anticipated. 

h2. What is ANKI? 

The JANKI method starts with ANKI, a multi-platform flash card program available for free download. You begin by creating a deck, say "Computer Science" within ANKI. A deck contains many facts, and each fact consists of a question, an answer, and as many tags as you like (e.g. 'rails', 'git', 'coffeescript', 'refactoring'). For example, you might have the following fact:
...
What makes ANKI special is the algorithm that determines when you ought to review a particular fact.
...
I'm certainly not the first person to use spaced-repetition-systems to learn programming, but the lack of publically available information on the topic suggests the pratice is not common. I think this is a shame since the technique is highly effective and I feel many programmers could benefit by adopting the practice. I've felt that the technique has given me such a headstart that I initially struggled with the idea of sharing it for fear of losing that headstart. I've since matured and I wish you the best of luck. If you enjoyed this post please retweet it. I'm visiting San Fran from now until Xmas 2011 so send me a message if you'd like to lunch/coffee/beer.
