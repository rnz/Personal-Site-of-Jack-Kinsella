The SuperFood Effect: Acceptance tests with cucuber, vested interests, and sloppy thought

I recently heard an account of a web development project both from the point of view of the consultancy doing the work and the client receiving it. The designer on the project told me how his company didn't compromise on what they know to be right right. In their latest gig they educated a client about how to do development work the Right Way. Although breaking down the clien't assumption about how things are done might annoy them at first,once they realize the consultancy's wisdom they will have won a lasting business relationship. Indeed the founder told me that him and the client were now "good friends".
...
Feature: In order to get more people to sign up
         As a current user
         I want to send my friend email invitations

 Scenario: sends an invitation
   Given a user with email "bob@bob.bob"
   When I sign in as "bob@bob.bob"
   And I follow "Invite via Email"
   And I fill in "Invitee" with "alex@example.com"
   And I press "Send an invitation"
   Then I that person should have recieved an invite 

This is purportedly stake-holder language. Bullshit. I've managed two development projects before, and I've also worked on a variety of projects for other stakeholder's. The following is the stake-holder language I know:

  I should be able to send invitations to my friends via email.

If it takes you twelves lines to communicate this idea, then you've wasted my time. And, considering that I'm the stakeholder here, why in earth's name are you "pausing to consider the business value of a feature". I, the client, have already determined the business value; in accepting a quote from you I've determine that the business benefit is worth its price. You second guessing using "in order to" steps is ficticious. This isn't your realm. Indeed, this is mild form of churning; in case you didn't know you weren't hired to play make-belief manager.

Conventienly the stake-holder language is expressed best with Test::Unit integration tests.

test "i should be able to send invitations to my friends via email" 

Smart members of the community, like say DHH, have been testing this way since the start. But you know better right? You've read the Cucumber homeage, seen the Peepcode and the Railscast (three times), you know that "Declarative testing" over imperative testing is the key to Cuking it Right, and have seen another forty or so slide decks on SlideShare repeating the same points without ever adding a modicum of critical thought.

Well you're thoroughly and demonstably wrong. You might be Cuking it right, but you shouldn't have been Cukin' at all. Don't worry though. I Cuked muy guts out for almost a year before finding some sense. It's not our fault. You see, we succumbed to the Superfood effect. 
