Cucumber: Hypocrisy and Waste in The Ruby Community

The price of Cucumber over integration tests, a look at Cucumber’s supposed advantages; and a simpler solution.

h2. Cucumber breaks your editor

Text editors, like VIM, multiple our productivity. Auto-completion lets us use long, descriptive Code Complete friendly method names without the need to type the name in full or remember its exact signature. Compilation upon saving catches many of our syntax errors before they harm . Our text editors reduce errors we introduce through typo, forgetfulness, or sloppiness.
...
h2. Cucumber requires we maintain parallel worlds
...
h2. Cucumber's routing causes cognitive strain
...
h2. Cucumber organisation defaults are impractical 
...
H2. Cucumber syntactically discourages simple code reuse.
