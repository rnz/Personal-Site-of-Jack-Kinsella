...
This is an essay about how Cucumber is the wrong tool for almost every job. I'm going to look at the advantages and disadvantages to using Cucumber, contrasting this with real world usage, and then draw up a schema for when Cucumber is justified as opposed to when its use it is outright unforgivable.
