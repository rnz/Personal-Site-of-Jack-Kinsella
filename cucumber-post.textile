...
The price of using Cucumber over straight integration tests; a critical look at its supposed advantages; and conclusions on whether you should still be using it.
...
h2. Cucumber oragnisation defaults are impractical 
